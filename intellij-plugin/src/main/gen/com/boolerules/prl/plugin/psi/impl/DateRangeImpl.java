...
public class DateRangeImpl extends PrlASTWrapperPsiElement implements DateRange {

  public DateRangeImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public DateList getDateList() {
    return findChildByClass(DateList.class);
  }
