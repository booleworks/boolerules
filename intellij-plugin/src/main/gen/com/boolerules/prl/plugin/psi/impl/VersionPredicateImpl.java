...
public class VersionPredicateImpl extends PrlASTWrapperPsiElement implements VersionPredicate {

  public VersionPredicateImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull Visitor visitor) {
    visitor.visitVersionPredicate(this);
  }
  ...
  public Comparator getComparator() {
    return findNotNullChildByClass(Comparator.class);
  }
  ...
  @NotNull
  public Num getNum() {
    return findNotNullChildByClass(Num.class);
  }
