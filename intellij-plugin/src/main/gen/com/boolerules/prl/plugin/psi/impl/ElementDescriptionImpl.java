...
public class ElementDescriptionImpl extends PrlASTWrapperPsiElement implements ElementDescription {

  public ElementDescriptionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull Visitor visitor) {
    visitor.visitElementDescription(this);
  }
