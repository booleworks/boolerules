...
public class HeaderPropertyNameImpl extends PrlASTWrapperPsiElement implements HeaderPropertyName {

  public HeaderPropertyNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull Visitor visitor) {
    visitor.visitHeaderPropertyName(this);
  }
