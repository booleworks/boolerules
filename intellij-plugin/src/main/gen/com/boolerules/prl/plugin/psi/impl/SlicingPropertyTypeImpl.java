...
public class SlicingPropertyTypeImpl extends PrlASTWrapperPsiElement implements SlicingPropertyType {

  public SlicingPropertyTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull Visitor visitor) {
    visitor.visitSlicingPropertyType(this);
  }
