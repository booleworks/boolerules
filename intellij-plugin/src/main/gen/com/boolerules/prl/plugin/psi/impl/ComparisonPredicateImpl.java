...
public class ComparisonPredicateImpl extends PrlASTWrapperPsiElement implements ComparisonPredicate {

  public ComparisonPredicateImpl(@NotNull ASTNode node) {
    super(node);
  }
