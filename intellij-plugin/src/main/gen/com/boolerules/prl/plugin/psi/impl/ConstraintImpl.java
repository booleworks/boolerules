...
public class ConstraintImpl extends PrlASTWrapperPsiElement implements Constraint {

  public ConstraintImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public Equivalence getEquivalence() {
    return findNotNullChildByClass(Equivalence.class);
  }
