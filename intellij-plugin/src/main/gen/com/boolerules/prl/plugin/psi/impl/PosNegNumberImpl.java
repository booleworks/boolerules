...
public class PosNegNumberImpl extends PrlASTWrapperPsiElement implements PosNegNumber {

  public PosNegNumberImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull Visitor visitor) {
    visitor.visitPosNegNumber(this);
  }
