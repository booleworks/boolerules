...
public class ImportDefImpl extends PrlASTWrapperPsiElement implements ImportDef {

  public ImportDefImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull Visitor visitor) {
    visitor.visitImportDef(this);
  }
  ...
  public ModuleRef getModuleRef() {
    return findChildByClass(ModuleRef.class);
  }
