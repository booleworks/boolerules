...
public class VersionedBoolFeatureRangeImpl extends PrlASTWrapperPsiElement implements VersionedBoolFeatureRange {

  public VersionedBoolFeatureRangeImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull Visitor visitor) {
    visitor.visitVersionedBoolFeatureRange(this);
  }
