...
public class IntFeatureRangeImpl extends PrlASTWrapperPsiElement implements IntFeatureRange {

  public IntFeatureRangeImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull Visitor visitor) {
    visitor.visitIntFeatureRange(this);
  }
