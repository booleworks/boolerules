...
public class ConjImpl extends PrlASTWrapperPsiElement implements Conj {

  public ConjImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull Visitor visitor) {
    visitor.visitConj(this);
  }
  ...
  public List<Lit> getLitList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, Lit.class);
  }
