...
public class SlicingPropertyDefImpl extends PrlASTWrapperPsiElement implements SlicingPropertyDef {

  public SlicingPropertyDefImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull Visitor visitor) {
    visitor.visitSlicingPropertyDef(this);
  }
