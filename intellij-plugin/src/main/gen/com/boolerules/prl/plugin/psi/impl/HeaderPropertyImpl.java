...
public class HeaderPropertyImpl extends PrlASTWrapperPsiElement implements HeaderProperty {

  public HeaderPropertyImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull Visitor visitor) {
    visitor.visitHeaderProperty(this);
  }
  ...
  @Override
  @NotNull
  public HeaderPropertyName getHeaderPropertyName() {
    return findNotNullChildByClass(HeaderPropertyName.class);
  }
