...
public class InIntPredicateImpl extends PrlASTWrapperPsiElement implements InIntPredicate {

  public InIntPredicateImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull Visitor visitor) {
    visitor.visitInIntPredicate(this);
  }
  ...
  public IntRange getIntRange() {
    return findNotNullChildByClass(IntRange.class);
  }
