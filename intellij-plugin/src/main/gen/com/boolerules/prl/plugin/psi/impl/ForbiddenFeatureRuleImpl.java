...
public class ForbiddenFeatureRuleImpl extends PrlASTWrapperPsiElement implements ForbiddenFeatureRule {

  public ForbiddenFeatureRuleImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull Visitor visitor) {
    visitor.visitForbiddenFeatureRule(this);
  }
