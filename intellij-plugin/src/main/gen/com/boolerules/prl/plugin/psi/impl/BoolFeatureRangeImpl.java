...
public class BoolFeatureRangeImpl extends PrlASTWrapperPsiElement implements BoolFeatureRange {

  public BoolFeatureRangeImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull Visitor visitor) {
    visitor.visitBoolFeatureRange(this);
  }
