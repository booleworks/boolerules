...
public class HeaderDefImpl extends PrlASTWrapperPsiElement implements HeaderDef {

  public HeaderDefImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull Visitor visitor) {
    visitor.visitHeaderDef(this);
  }
  ...
  public HeaderContent getHeaderContent() {
    return findChildByClass(HeaderContent.class);
  }
