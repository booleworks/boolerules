...
internal class CoverageComputationWithSlicesTest : TestWithConfig() {
    ...
    fun testComputeWithConstraints(tc: TestConfig) {
        ...
        assertThat(status.warnings).containsExactlyInAnyOrder(
            """For slice Slice({version 1=SPLIT, series "S1"=SPLIT}) the following constraints could not be compiled or transpiled and are therefore not covered by the result: -p / q, -p & -z, (-b / z) & (x / y / r), (r / x) & (-c / -q)""",
            """For slice Slice({version 1=SPLIT, series "S2"=SPLIT}) the following constraints could not be compiled or transpiled and are therefore not covered by the result: -p / q, -p & -z, (-b / z) & (x / y / r), (r / x) & (-c / -q)""",
            """For slice Slice({version 1=SPLIT, series "S3"=SPLIT}) the following constraints could not be compiled or transpiled and are therefore not covered by the result: -p / q, -p & -z, (-b / z) & (x / y / r), (r / x) & (-c / -q)""",
            """For slice Slice({version 2=SPLIT, series "S1"=SPLIT}) the following constraints could not be compiled or transpiled and are therefore not covered by the result: -p / q, (-b / z) & (x / y / r), (r / x) & (-c / -q)""",
            """For slice Slice({version 2=SPLIT, series "S2"=SPLIT}) the following constraints could not be compiled or transpiled and are therefore not covered by the result: -p / q, -p & -z, (-b / z) & (x / y / r), (r / x) & (-c / -q)""",
            """For slice Slice({version 2=SPLIT, series "S3"=SPLIT}) the following constraints could not be compiled or transpiled and are therefore not covered by the result: -p / q, -p & -z, (r / x) & (-c / -q)""",
            """For slice Slice({version 3=SPLIT, series "S1"=SPLIT}) the following constraints could not be compiled or transpiled and are therefore not covered by the result: -p / q, (-b / z) & (x / y / r), (r / x) & (-c / -q)""",
            """For slice Slice({version 3=SPLIT, series "S2"=SPLIT}) the following constraints could not be compiled or transpiled and are therefore not covered by the result: -p / q, -p & -z, (-b / z) & (x / y / r), (r / x) & (-c / -q)""",
            """For slice Slice({version 3=SPLIT, series "S3"=SPLIT}) the following constraints could not be compiled or transpiled and are therefore not covered by the result: -p / q, -p & -z, (-b / z) & (x / y / r), (r / x) & (-c / -q)""",
            """For slice Slice({version 3=SPLIT, series "S1"=SPLIT}) the following constraints were not buildable and are therefore not covered by the result: -a & -c""",
            """For slice Slice({version 3=SPLIT, series "S2"=SPLIT}) the following constraints were not buildable and are therefore not covered by the result: -a & -c""",
        ...
        assertThat(result[s11]!!.result).hasSize(2)
        assertThat(result[s21]!!.result).hasSize(2)
        assertThat(result[s31]!!.result).hasSize(2)
        ...
        assertThat(result[s33]!!.result).hasSize(1)
    }
}
