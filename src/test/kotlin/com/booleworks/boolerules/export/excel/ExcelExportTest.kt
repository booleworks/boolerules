...
class ExcelExportTest {
    ...
    private val ccResponse = ComputationStatusBuilder("62198eea-7fb4-4487-af2f-fba902b2b512", "", SINGLE).let { status ->
    ...
    private val mcResponse = ComputationStatusBuilder("62198eea-7fb4-4487-af2f-fba902b2b512", "", SINGLE).let { status ->
    ...
    private val bbResponse = ComputationStatusBuilder("62198eea-7fb4-4487-af2f-fba902b2b512", "", SINGLE).let { status ->
    ...
    private val meResponse = ComputationStatusBuilder("62198eea-7fb4-4487-af2f-fba902b2b512", "", SINGLE).let { status ->
    ...
    private val mmResponse = ComputationStatusBuilder("62198eea-7fb4-4487-af2f-fba902b2b512", "", SINGLE).let { status ->
    ...
    private val opResponse = ComputationStatusBuilder("62198eea-7fb4-4487-af2f-fba902b2b512", "", SINGLE).let { status ->
...
private fun <MAIN> genSingleResponse(res: List<SliceComputationResult<MAIN>>, status: ComputationStatusBuilder): SingleComputationResponse<MAIN> =
    SingleComputationResponse(status.build(), res)

private fun <MAIN, ELEMENT> genListResponse(res: Map<ComputationElement<ELEMENT>, MergeResult<MAIN, *>>, status: ComputationStatusBuilder):
